...
export const WEB_APP_URL = "https://usegivest.app";
export const RELAYER_CLAIM_URL = `${WEB_APP_URL}/api/claim`;

/** Deployed Givest escrow contract (mirrors NEXT_PUBLIC_CONTRACT_ADDRESS on the web). */
export const CONTRACT_ADDRESS =
  "0xA318294016823c058E9c4d4f7FA4F5aef41775cC" as Address;

/** Givest token for holder fee discounts. */
export const GIVEST_TOKEN =
...
export type Stock = {
  ...
  feed: Address | null;
  /** Remote logo URL (custom tokens). Listed stocks use usegivest.app/logos/{symbol}.png. */
  icon?: string | null;
};
